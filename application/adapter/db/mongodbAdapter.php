...
class mongodbAdapter
{
	...
	*/
	...
	$connection_string = "mongodb://";show_error()
...
/*
include('mongodb_db.adp.php');
$ci_mongodb = new mongodb_db();
$ci_mongodb->offset(1);
$ci_mongodb->limit(2);
$array = $ci_mongodb->select(array('btime', 'xt'))->get('beacon');
print_r($array);
